...
exports.updateSubmission = async (req, res) => {
  try {
    ...
    delete updateFields.trackingCode;
    delete updateFields.note;

    // Handle incidentDate parsing if it is sent as string
    if (updateFields.incidentDate) {
      updateFields.incidentDate = new Date(updateFields.incidentDate);
    }
